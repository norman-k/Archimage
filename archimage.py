...
magician1 = [0,0,0,0] #room 38
magician2 = [0,0,0,0] #room 39
magician3 = [0,0,0,0] #room 40
magician4 = [0,0,0,0] #room 41
magician5 = [0,0,0,0] #room 42
magician6 = [0,0,0,0] #room 43
rl = [0,46,0,0] #room 45
rl_s = [45,47,0,0] #room 46
house_entrance = [46,48,0,0] #room 47
alchemy = [47,49,0,0]
room_map = [null,hall,staircase,wine_cellar,kitchen,armory,closet, #first floor
            ...
            barrons_garden,treasure,grass4,grass5,grass6,magician1, #Barrons Garden
            magician2,magician3,magician4,magician5,magician6,
            rl,rl_s,house_entrance,alchemy #world 2
            ] 
room_descriptions = {
    ...
    45:'...',
    46:'Here we are',
    47:'You see an old carved out entrance on bedrock, near a chisle laying beside it',
    48:'You enter a rusty cabin'
    }
room_items = {
    0:None,
    1: 'shattered_glass',
...
def inspect():
    ...
    if index == 7 and 'key' not in player.inventory:
    	...
    	print 'You develop a stream of conciousness'
    	print '...'
    	print '...'
    	print '.....Hello?'
    	index += 1
    elif index == 40:
    	print 'You see the strange figure'
    	index += 1
    elif index == 41:
    	print 'I do not get many visitors these days'
    	index += 1
    elif index == 42:
    	print 'I am the Magician Sryjak, and I come to you in misfortune'
    	index += 1
    elif index == 43:
    	print 'Whats that you say? A magician asking for help? I have a special chore'
    	print '...and I need someone like you to do it. Enough questions.'
    	index += 1
    elif index == 44:
    	print '...Vrshzz....'
    	index += 1
    elif index == 48:
        print 'Here take my spare alembic, I use it for distilling chemicals'
    else:
